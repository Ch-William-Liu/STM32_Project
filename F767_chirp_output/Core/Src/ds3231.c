...
{
    return ((uint64_t )rtc->year * 10000000000ULL)
            + ((uint64_t )rtc->month * 100000000ULL)
            + ((uint64_t )rtc->date * 1000000ULL)
            + ((uint64_t )rtc->hour * 10000ULL)
            + ((uint64_t )rtc->minute * 100ULL)
            + ((uint64_t )rtc->second);
